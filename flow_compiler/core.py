...
Contains ``compile_flows`` orchestration, actor resolution, trace expansion,
and optional-group flattening. Per-step compilation lives in
``core_step_compile``; emission in ``core_emit``.
"""
