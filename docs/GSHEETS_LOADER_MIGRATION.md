...
| History Tool (curl, payloads, balances) | **Runs** + manifests under `runs/`, **Execute** SSE stream, **Listener**; CLI `scripts/mt_ops.py` for list-by-metadata and ledger balance |
