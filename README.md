...
Each `funds_flows` entry may include optional **`display_title`** (≤120 chars) and **`display_summary`** (≤500) for the Fund Flows list cards; they do not affect compilation.
...
static/              CSS
examples/            7 example configs (marketplace, stablecoin, tradeify, staged, psp, funds_flow, lending); each flow lists optional display_title / display_summary for Fund Flows UI
...
**MINT / MT UI layout:** [`docs/PORTING-KIT.md`](docs/PORTING-KIT.md), [`docs/DESIGN_SYSTEM_AUTHORITY.md`](docs/DESIGN_SYSTEM_AUTHORITY.md), [`docs/VISUAL_LAYER.md`](docs/VISUAL_LAYER.md) (semantic tokens + CSS hygiene), [`docs/RESOURCES.md`](docs/RESOURCES.md) (optional token regen). **Naming / preview / display pipelines:** [`docs/ARCHITECTURE_NAMING_AND_DISPLAY.md`](docs/ARCHITECTURE_NAMING_AND_DISPLAY.md).
