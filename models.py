...
class IdentificationConfig(BaseModel):
    ...
    id_number: str
    id_type: Literal[
        "ar_cuil", "ar_cuit", "br_cnpj", "br_cpf", "cl_rut", "co_cedulas",
        "co_nit", "drivers_license", "gb_national_insurance", "hn_id",
        "in_lei", "kr_brn", "kr_crn", "kr_rrn", "passport", "sa_tin",
        "sa_vat", "us_ein", "us_itin", "us_ssn", "vn_tin",
    ]
